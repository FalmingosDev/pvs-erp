...
class Supp_payroll extends MY_Controller {
	...
	public function __construct() {
        ...
        $this->load->model('client_supp_attendance/Client_supp_attendance_model','cam');
        $this->load->model('Supp_payroll_model','pm');
	}
        ...
        if(!empty($this->input->post())){
            ...
            //if ($this->form_validation->run() == TRUE){
                ...
                if($qry) {
                 ...
                 redirect(base_url('supp_payroll'));
                }
