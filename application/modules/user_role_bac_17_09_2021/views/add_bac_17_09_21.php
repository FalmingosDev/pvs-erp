			...
			row_html +='<div class="row">';
				row_html +='<div class="col-md-6">';
					row_html +='<div class="form-group row">';
						...
						row_html +='<label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm ">User Name : </label>';
				...
				row_html +='<div class="col-md-6">';
					row_html +='<div class="form-group row">';
						...
						row_html +='<div class="col-sm-6">';
								...
								row_html +='<select class="form-control form-control-sm" id="resource_id_'+cnt+'" name="resource_id[]" onchange="deg(cnt)">';
