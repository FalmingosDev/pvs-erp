            ...
            <div class="row">
                ...
                <?php if($this->session->flashdata('msg')): ?>
                    ...
                    <div class="tab-pane fade show active" id="nav-client" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="row">
                                    <div class="col-md-11">
                                        <h1 class="employee-box">Tally Billing Entry</h1>   
                                    </div>
                                    <div class="col-md-1">
                                        <a class="cr-a" href="<?=base_url('tally_billing')?>">Back</a>
                                    </div>
                                </div> 
                          <?php echo form_open( base_url( 'tally_billing/add' ), array( 'id' => 'tallyBilling', 'class' => 'form-horizontal' ) ); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter customer ledeger code" name="customer_ledger_code" id="customer_ledger_code" value="<?php echo set_value('customer_ledger_code'); ?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter igst code" name="igst_code" id="igst_code" value="<?php echo set_value('igst_code'); ?>">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter cost category" name="cost_category" id="cost_category" value="<?php echo set_value('cost_category'); ?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter cast center" name="cast_center" id="cast_center" value="<?php echo set_value('cast_center'); ?>">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter sales head code" name="sales_head_code" id="sales_head_code" value="<?php echo set_value('sales_head_code'); ?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter cgst code" name="cgst_code" id="cgst_code" value="<?php echo set_value('cgst_code'); ?>">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter sgst code" name="sgst_code" id="sgst_code" value="<?php echo set_value('sgst_code'); ?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter ugst code" name="ugst_code" id="ugst_code" value="<?php echo set_value('ugst_code'); ?>">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter add tax code" name="add_text_code" id="add_text_code" value="<?php echo set_value('add_text_code'); ?>">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter round of" name="round_of" id="round_of" value="<?php echo set_value('round_of'); ?>">
                                        </div>
