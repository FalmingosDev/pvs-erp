...
class Client_model extends CI_Model {
	...
	public function insertClient($client_name,$client_code,$old_client_code,$address_line_1,$agreemnt_start_date,$agreemnt_end_date,$address_line_2,$type_id,$address_line_3,$rating_id,$state_id,$location,$city_id,$tel_nos,$pincode,$fax,$foundation_day,$client_email,$mw_type_id,$website,$source_id, $contract_status_id,$source_ref,$name,$designation,$contact_no,$email,$birthday,$anniversary,$remarks,$billing_method)
	{
		...
		$query = $this->db->query("EXEC add_client_proc @p_client_name = '" . escape_str($client_name) . "',@p_client_code = '" .$client_code. "', @p_old_client_code = '". $old_client_code ."', @p_agreement_start_date = '".$start_date."', @p_agreement_end_date = '".$end_date."', @p_address_1 = '".escape_str($address_line_1)."' ,@p_industry_type_id = '".$type_id."' , @p_rating_id = '".$rating_id."', @p_location_type = '".$location."',@p_address_2 = '".escape_str($address_line_2)."', @p_address_3 = '".escape_str($address_line_3)."', @p_state_id = '".$state_id."', @p_city_id = '".$city_id."', @p_pincode = '". escape_str($pincode)."', @p_contact_no = '".escape_str($tel_nos)."', @p_fax_no = '".escape_str($fax)."',@p_email = '".escape_str($client_email)."', @p_website = '".escape_str($website)."', @p_foundation_date = '".$foundation_date."', @p_contract_status_id = '".$contract_status_id."', @p_mw_type_id = '".$mw_type_id."', @p_source_id = '".$source_id."', @p_source_reference = '".escape_str($source_ref)."',@p_user_id = '".$user_id."',@p_remarks = '".escape_str($remarks)."',@p_billing_method = '".$billing_method."', @p_detail_data = '". $detail_data."'");
    ...
    public function getClientCode() {
    	//echo "1";die;
		$query = $this->db->query("SELECT [dbo].[getClientCode] () as client_code");
		return $query->row();
	}
