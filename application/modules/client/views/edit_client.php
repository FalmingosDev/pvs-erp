                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" name="client_code" maxlength="255" class="form-control form-control-sm" id="" placeholder="Client code" readonly="" value="<?php echo (set_value('client_code')) ? set_value('client_code') : $client->client_code; ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" name="old_client_code" maxlength="255" class="form-control form-control-sm" id="" placeholder="Old Client code" value="<?php echo (set_value('old_client_code')) ? set_value('old_client_code') : $client->old_client_code; ?>">
