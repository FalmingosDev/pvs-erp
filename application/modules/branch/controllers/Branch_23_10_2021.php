		...
		if(!empty($this->input->post())){
            ...
            if ($this->form_validation->run() == TRUE)
             { 
                ...
                $this->bm->insertBranch($client_id,$address_line_1,$branch_name,$address_line_2,$fax,$address_line_3,$cont_no,$state_id,$client_email,$city_id,$sole_id,$pincode,$app_by,$name,$designation,$contact_no,$email,$birthday,$anniversary,$remarks,$branch_code,$branch_category_id);
	...
	public function city_list(){
		...
		if(!empty($this->input->post())){
			...
			$branch_id = $this->input->post('branch_id');
				...
				$this->bm->updateBranch($client_id,$branch_id,$detail_id,$address_line_1,$branch_name,$address_line_2,$fax,$address_line_3,$cont_no,$state_id,$client_email,$city_id,$sole_id,$pincode,$app_by,$name,$designation,$contact_no,$email,$birthday,$anniversary,$remarks,$branch_code,$branch_category_id);
