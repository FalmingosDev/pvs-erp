                      ...
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row pb-2">
                                    <div class="col-md-11">
                                        <h1 class="text-center">Edit PVS Branch</h1>
                                    </div>
                                    <div class="col-md-1">
							...
							<?php foreach($cbranchview as $view){ ?>
							<?php echo form_open( base_url( 'companybranch/edit_cbranch' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) ); ?>
								<div class="wrapper-box">
                                <form>	
								<input type="hidden" name="id" value="<?php echo $view->company_branch_id; ?>">								
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                          <input type="text" class="form-control form-control-sm" placeholder="Branch Name" id="branch_name" name="branch_name" value="<?php echo $view->branch_name; ?>">
                                                    </div>
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input class="form-control form-control-sm" type="text" name="branch_short_name" id="branch_short_name" placeholder="Branch Short Name" value="<?php echo $view->branch_short_name; ?>">
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input class="form-control form-control-sm" type="text" name="address_1" id="address_1" placeholder="Address 1"value="<?php echo $view->address_1; ?>">
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input class="form-control form-control-sm" type="text" name="address_2" id="address_2" placeholder="Address 2"value="<?php echo $view->address_2; ?>">
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input class="form-control form-control-sm" type="text" name="address_3" id="address_3" placeholder="Address 3"value="<?php echo $view->address_3; ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<?php 
															...
															$selected = (set_value('state_id')) ? set_value('state_id') : $view->state_id;
                                                    ...
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">City  <span class="help-inline">*</span> : </label>
														<div class="col-sm-9">
														 <?php 
																...
																$selected = (set_value('city_id')) ? set_value('city_id') : $view->city_id;
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input required class="form-control form-control-sm" type="text" name="pin" id="pin" placeholder="Pin"value="<?php echo $view->pincode; ?>">
