   ...
   <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
                    Home</a> <a href="#" class="tip-bottom">Department</a> <a href="#" class="current">Add Department</a> </div>
                        ...
                        <div class="widget-content nopadding">
                            <!-- <form role="form" action="<?php //echo base_url('department/insertDepartment') ?>" method="post" class="form-horizontal"> -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" name="department_name" placeholder="Department name" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span11" name="department_short_name" placeholder="Department Short name" />
