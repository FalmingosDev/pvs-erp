                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <input type="text" class="form-control form-control-sm" name="department_name" placeholder="Department name" value="<?php echo $ed_dept['dept_name']; ?>" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" name="department_short_name" placeholder="Department Short name" value="<?php echo $ed_dept['dept_short_name']; ?>" />
