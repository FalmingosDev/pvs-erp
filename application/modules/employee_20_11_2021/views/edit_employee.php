                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                      <label class="cont-radio-location"><input type="radio" name="job_type" value="G" <?php if($emp->job_type=='G') echo "checked='checked'"; ?> <?php echo set_checkbox('job_type', 'G'); ?>>Staff</label>
                                                        <label class="cont-radio-location"><input type="radio" name="job_type" value="C" <?php if($emp->job_type=='C') echo "checked='checked'"; ?> <?php echo set_checkbox('location', 'C'); ?>>Contractual</label>
