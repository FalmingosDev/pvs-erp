    ...
    <section class="per-section">
        ...
        <div class="row">
            ...
            <div class="col-md-1 offset-md-8">
                ...
                <div class="col-md-2">
                    <a href="<?php echo base_url('employee/personal_declaration_pdf/'.$personal_declaration->employee_id); ?>" class="cr-a">PDF Download</a>
                </div>
                <div class="col-md-1">
                    <a href="<?php echo base_url('employee'); ?>" class="cr-a">Back</a>
                </div>
            </div>
            <p class="text-left"><b>PVS FORM NO. 102</b></p>
            <h4 class="text-center"><b><u>PERSONAL DECLARATION BY CANDIDATE</u></b></h4>
            <div class="row">
