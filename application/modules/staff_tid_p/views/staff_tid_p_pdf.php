...
<html>
<head>
<title>Staff Payment Bank Transfer Statement PDF</title>
</head>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="width: 100%;font-weight: bold;text-align: right;">
                <table style="width: 100%;">
                    <tr>
                        <td style="width: 50%;font-weight: bold;font-size: 13px;text-align: left;">
                            Staff Payment Bank Transfer Statement
                        </td>
                ...
                <table style="width: 100%;border: 1px solid #000;">    
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; border: 1px solid #000;"><?PHP echo $list->unit; ?></td>
