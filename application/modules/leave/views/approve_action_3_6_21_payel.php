                      ...
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php endif; ?>
                                <?php echo form_open( base_url('leave/approve_action/'.$leave_details->leave_id ), array( 'id' => 'apply-form', 'class' => 'form-horizontal' ) ); ?>
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="col-md-2">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="checkbox" name="half_day" class="form-control form-control-sm" id="half_day" readonly="" value="1" <?php echo set_checkbox('half_day', '1'); ?> style="width: 70%;">  
                                                            </div>
                                                        </div>
                                                    </div>
