                                ...
                                <div class="row pb-2">
                                    ...
                                    <div class="col-md-5">
                                        <div class="add-btn-div">
                                            <a href="<?php echo base_url('mw_type'); ?>" class="ad-btn-a-tag">Rating List</a>  
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <input type="text" class="form-control form-control-sm" name="mw_type_name" placeholder="Mw Type name" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" name="mwtype_short_name" placeholder="Mw Type Short name" />
