...
<section class="main-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php echo form_open( base_url( 'delete_supp_salary/delete' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) );  ?>
                
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="text-align: center;">Delete Supplimentary Salary Payment</h1>
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-4">
...
<script>
   $(document).ready(function() {
    ...
    if (($("#month_year").val() != null)){
        ...
        $.ajax({
            type: 'POST',   
            url: '<?php echo base_url('delete_supp_salary/branch_list'); ?>',
...
function populateclient(month_year){
    ...
    $.ajax({
        type: 'POST',   
        url: '<?php echo base_url('delete_supp_salary/client_list'); ?>',
        data: {month_year: month_year,<?= $this->security->get_csrf_token_name(); ?>: $("[name='<?= $this->security->get_csrf_token_name(); ?>']").val()},
        dataType: 'json',
        encode: true,
    })
...
$.ajax({
 type:'POST',
 url: '<?php echo base_url('delete_supp_salary/search'); ?>',
...
function confirmation(payment_month,client_id,branch_id){
        ...
        $.ajax({
			type: 'POST',   
			url: '<?php echo base_url('delete_supp_salary/delete'); ?>',
