...
<section class="main-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php  echo form_open( base_url( 'supplimentary_tid_report/tid_excel' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) );  ?>
                <div class="row">
                    <div class="col-md-7"> 
                        <h1 style="text-align: center;">Supplimentary TID Report</h1>
                    </div>
                </div>
                    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    <th>TID</th>
                                    <th>Supplimentary Code</th>
                                    <th>Supplimentary Name</th>
                                    <th>Branch Code</th>
                                    <th>Branch Name</th>
...
<script>
    ...
    function staff_search()
    {
		...
		$.ajax({
			type: 'POST',   
			url: '<?php echo base_url('supplimentary_tid_report/search'); ?>',
