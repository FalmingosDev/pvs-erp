                                                    ...
                                                    <table class="table table-bordered">
                                                      ...
                                                      <tbody id="tab_body">
                                                        ...
                                                        <tr width="100%" class="add_more_detail" id="add_more_detail'<?php echo $i; ?>'" style="">
                                                            ...
                                                            <td>
                                                            <select name="calculation_type[]" class="form-control form-control-sm" id="calculation_type<?php echo $i; ?>" value="<?php echo $it_deduction_detail['calculation_type'][$i]; ?>" onchange="checkTypeDetail(this.value, <?php echo $i; ?>);">
                                                            <option value = "">Select Calculation Type </option>  
                                                             <option value = "A"> Amount </option>  
                                                            <option value = "P"> Percentage </option> 
                                                            <option value = "N"> N/A </option>
                                                            ...
                                                            <?php 
                                                                   /* $attributes = array('class' => 'form-control form-control-sm', 'id' => 'calculation_type'.$i);
                                                                    echo form_dropdown('calculation_type[]', $calculation_type, $it_deduction_detail['calculation_type'][$i], $attributes);*/
                                                              ?>
                                                        <?php /*
                                                            $options = array('A' => 'Amount', 'P' => 'Percentage', 'N' => 'N/A');
                                                            $attributes = array('class' => 'form-control form-control-sm', 'id' => 'calculation_type','onchange="checkTypeDetail(this.value, <?php echo $i; ?>);"');
                                                            $selected_calculation_type = (set_value('calculation_type')) ? set_value('calculation_type') : $it_deduction_detail->calculation_type;
                                                            echo form_dropdown('calculation_type', $options, $selected_calculation_type, $attributes);
                                                        */ ?>
                                                        ...
                                                        <tr width="100%" class="add_more_detail" id="add_more_detail'<?php echo $i; ?>'" style="">
                                                            ...
                                                            <select name="calculation_type[]" class="form-control form-control-sm" id="calculation_type<?php echo $i; ?>"value="<?php echo $detail['calculation_type']; ?>" onchange="checkTypeDetail(this.value, <?php echo $i; ?>);">
                                                            <option value = "">Select Calculation Type </option>  
                                                             <option value = "A"> Amount </option>  
                                                            <option value = "P"> Percentage </option> 
                                                            <option value = "N"> N/A </option> 
                                                            ...
                                                            <?php 
                                                                   /* $attributes = array('class' => 'form-control form-control-sm', 'id' => 'calculation_type'.$i);
                                                                    echo form_dropdown('calculation_type[]', $calculation_type, $detail['calculation_type'], $attributes); */
                                                              ?>
                                                                <?php /*
                                                                        $options = array('A' => 'Amount', 'P' => 'Percentage', 'N' => 'N/A');
                                                                        $attributes = array('class' => 'form-control form-control-sm', 'id' => 'calculation_type','onchange="checkTypeDetail(this.value, <?php echo $i; ?>);"');
                                                                        $selected_calculation_type = (set_value('calculation_type')) ? set_value('calculation_type') : $detail->calculation_type;
                                                                        echo form_dropdown('calculation_type', $options, $selected_calculation_type, $attributes);
                                                                    */ ?>

                                                            </td>
                                                    <td><input type="text" name="max_limit[]" class="form-control form-control-sm" id="max_limit<?php echo $i; ?>" value="<?php echo $detail['max_limit']; ?>"></td>
