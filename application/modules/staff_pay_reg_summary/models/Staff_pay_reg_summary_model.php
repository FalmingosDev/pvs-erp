<?php
class Staff_pay_reg_summary_model extends CI_Model {
	...
	public function list_proc($month_id,$branch_id)
	{
		$client_id='';
		$emp_id='';
		...
		$query = $this->db->query("EXEC staff_pay_reg_proc @p_month_id= '". $month_id ."',@p_client_id= '". $client_id ."',@p_emp_id= '". $emp_id ."',@p_branch_id= '". $branch_id ."'  ");
