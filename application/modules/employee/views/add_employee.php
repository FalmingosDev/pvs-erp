                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="wrapper-box">
                                    ...
                                    <?php echo form_open_multipart( base_url( 'employee/add' ), array( 'id' => 'employeeform', 'class' => 'form-horizontal form-hori-border','onSubmit' => 'return validDetail()' ) ); ?>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                      <label class="cont-radio-location"><input type="radio" name="job_type" value="G" <?php echo set_checkbox('job_type', 'G'); ?>>Staff</label>
                                                        <label class="cont-radio-location"><input type="radio" name="job_type" value="C" <?php echo set_checkbox('job_type', 'C'); ?>>Contractual</label>
                                                        <label class="cont-radio-location"><input type="radio" name="job_type" value="B" <?php echo set_checkbox('job_type', 'B'); ?>>Contractual Staff</label>
                                                    </div>
                                                      ...
                                                      <?php if($user_branch_id == 1)
                                                        {
                                                            ...
                                                            $selected = (set_value('company_branch_id')) ? set_value('company_branch_id') : '';
                                            ...
                                            <div class="col-md-10">
                                              ...
                                              <!-- <div class="col-md-5">
                                                <div class="row form-group row">
                                                        <label class="col-md-5 col-form-label col-form-label-sm">Employee Code : </label>
                                                    <div class="col-md-7">
                                                        <input type="text" name="employee_code" id="employee_code" readonly="" value="1" class="form-control form-control-sm">
                                                    </div>
                                                </div>
                                              </div> -->
                                              <div class="col-md-8">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php 
                            															...
                            															$selected = (set_value('desig_id')) ? set_value('desig_id') : '';
                                            ...
                                            <div class="row">
                                              <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control form-control-sm" name="fname" id="fname" value="<?php echo set_value('fname'); ?>">
                                                    </div>
                                              ...
                                              <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="lname" value="<?php echo set_value('lname'); ?>">
                                                    </div>
                                              ...
                                              <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="old_code" value="<?php echo set_value('old_code'); ?>">
                                                    </div>
                                                </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="col-md-5">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control form-control-sm" name="father_name" value="<?php echo set_value('father_name'); ?>">
                                                    </div>
                                              ...
                                              <div class="col-md-7">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="old_name" value="<?php echo set_value('old_name'); ?>">
                                                    </div>
                                                </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="col-md-5">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control form-control-sm" name="mother_name" value="<?php echo set_value('mother_name'); ?>">
                                                    </div>
                                              ...
                                              <div class="col-md-7">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="army_no" value="<?php echo set_value('army_no'); ?>">
                                                    </div>
                                                </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="col-md-5">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control form-control-sm" name="spouse_name" value="<?php echo set_value('spouse_name'); ?>">
                                                    </div>
                                                </div>
                                              </div>
                                              <div class="col-md-7">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="rank" value="<?php echo set_value('rank'); ?>">
                                                    </div>
                                              ...
                                              <div class="col-md-2">
                                                <p class="pt-graph">Photograph <span class="help-inline">*</span></p>
                                                  <input type="file" style="width: 100%;" name="photo" id="photo">   
                                                  <div class="user-photo">
                                                    <img src="<?php echo base_url('assets/img/user.png'); ?>" class="img-fluid" />
                                                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="birth_place" value="<?php echo set_value('birth_place'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="chest" value="<?php echo set_value('chest'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="date" class="form-control form-control-sm" name="dob" id="dob" value="<?php echo set_value('dob'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="height" value="<?php echo set_value('height'); ?>">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="weight" value="<?php echo set_value('weight'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="pf_no" value="<?php echo set_value('pf_no'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="hair_color" value="<?php echo set_value('hair_color'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="eye_color" value="<?php echo set_value('eye_color'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="esi_no" value="<?php echo set_value('esi_no'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="row form-group row">
                                                    ...
                                                    <?php 
                                                            ...
                                                            $selected = (set_value('sex')) ? set_value('sex') : '';
                                                ...
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php 
                              															...
                              															$selected = (set_value('blood_group_id')) ? set_value('blood_group_id') : '';
                                                ...
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php 
                                                            ...
                                                            $selected = (set_value('marital_status')) ? set_value('marital_status') : '';
                                            ...
                                            <div class="col-md-3">
                                                    <div class="row form-group row">
                                                        <label class="col-md-4 col-form-label col-form-label-sm">DOJ : <span class="help-inline">*</span></label></label>
                                                        <div class="col-md-8">
                                                            <input type="date" class="form-control form-control-sm" id="doj" name="doj" value="<?php echo set_value('doj'); ?>">
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    <label class="col-md-4 col-form-label col-form-label-sm">Complexion <span class="help-inline">*</span> </label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="complexion" value="<?php echo set_value('complexion'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="date" class="form-control form-control-sm" name="doa" id="doa" value="<?php echo set_value('doa'); ?>">
                                                    </div>
                                            ...
                                            <!-- <div class="col-md-3" style="display: none;">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="date" class="form-control form-control-sm" name="dol" value="<?php //echo set_value('dol'); ?>">
                                                    </div>
                                                </div>
                                            </div> -->
                                            <div class="col-md-4">
                                                    <div class="row form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control form-control-sm" name="uan" value="<?php echo set_value('uan'); ?>">
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="id_mark" value="<?php echo set_value('id_mark'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="language" value="<?php echo set_value('language'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="caste" value="<?php echo set_value('caste'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="religion" value="<?php echo set_value('religion'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    <div class="col-md-12">    
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control form-control-sm" name="tenure_date_1" id="tenure_date_1" value="<?php echo set_value('tenure_date_1'); ?>">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control form-control-sm" name="tenure_date_2" id="tenure_date_2" value="<?php echo set_value('tenure_date_2'); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control form-control-sm" name="nationality" value="<?php echo set_value('nationality'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-9">
                                                 <div class="row">
                                                  ...
                                                  <div class="col-md-8">
                                                   <input type="text" class="form-control form-control-sm" name="nomminee_name" value="<?php echo set_value('nomminee_name'); ?>">
                                                    </div>
													<?php echo form_error('nomminee_name', '<span class="help-inline">', '</span>'); ?>
                                                  </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control form-control-sm" name="age" value="<?php echo set_value('age'); ?>">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Bank Name :<span class="help-inline">*</span></label>
                                                    <div class="col-sm-9">
                                                        <?php 
                                                            //$options = array('' => 'Please Select Bank','SBI' => 'SBI', 'BOB' => 'BOB', 'BOI' => 'BOI');
                                                            $attributes = array('class' => 'form-control form-control-sm', 'id' => 'bank_name');
                                                            $selected = (set_value('bank_name')) ? set_value('bank_name') : '';
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Account Number" name="account_number"  value="<?php echo set_value('account_number'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control form-control-sm" placeholder="IFSC Code" name="ifsc_code"  value="<?php echo set_value('ifsc_code'); ?>">
                                                    </div>
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Aadhaar Number" name="aadhaar_number"  value="<?php echo set_value('aadhaar_number'); ?>" maxlength="14" >
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" placeholder="Vill & Po" name="p_address_1" value="<?php echo set_value('p_address_1'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Vill & Po <span class="help-inline">*</span> </label>
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" id="" placeholder="Vill & Po" name="c_address_1" value="<?php echo set_value('c_address_1'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" placeholder="Tehsil,Police Stn" name="p_address_2" value="<?php echo set_value('p_address_2'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm pr-0">Tehsil,Police Stn <span class="help-inline">*</span> </label>
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" id="" placeholder="Tehsil,Police Stn" name="c_address_2" value="<?php echo set_value('c_address_2'); ?>">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" placeholder="Dist" name="p_address_3" value="<?php echo set_value('p_address_3'); ?>">
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Dist  <span class="help-inline">*</span> </label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" placeholder="Dist" name="c_address_3" value="<?php echo set_value('c_address_3'); ?>">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php 
															...
															$selected = (set_value('p_state_id')) ? set_value('p_state_id') : '';
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                    	<?php 
															...
															$selected = (set_value('c_state_id')) ? set_value('c_state_id') : '';
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php 
															...
															$selected = (set_value('p_city_id')) ? set_value('p_city_id') : '';
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php 
															...
															$selected = (set_value('c_city_id')) ? set_value('c_city_id') : '';
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" name="residing_since" value="<?php echo set_value('residing_since'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Tel Nos <span class="help-inline">*</span> </label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" name="tel_nos" value="<?php echo set_value('tel_nos'); ?>">
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" name="dispensery" value="<?php echo set_value('dispensery'); ?>">
                                                    </div>
                                                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input type="checkbox" class="form-control form-control-sm" name="background_check" value="1" style="width: 70%;">
                                                    </div>
                                                  </div>
                                            </div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <h4 class="pr-h4">Family Details For PF and ESI</h4>
                                                    </div>
                                                  </div>
                                            </div>
                                                ...
                                                <table class="table table-bordered tb-bl">
                                                  ...
                                                  <tbody id="tab_body_1">
                                                      <?php if(!empty($employee)){ ?>
                                                        ...
                                                        <?php  $i = 0; foreach($employee['name'] as $contact){ ?>
                                                        <?php //print_r($contact); ?>
                                                        <tr width="100%" class="add_more_contact" id="add_more_contact'<?php echo $i; ?>'" style="">
                                                            ...
                                                            <td><input type="text" name="family_dob[]" class="form-control form-control-sm" id="family_dob<?php echo $i; ?>" value="<?php echo $employee['family_dob'][$i]; ?>"></td>
                                                            ...
                                                            <td><input type="text" name="aadhaar_no[]" id="aadhaar_no<?php echo $i; ?>" maxlength="14" class="form-control form-control-sm" value="<?php echo $employee['aadhaar_no'][$i]; ?>"></td>
                                                            <td>
                                                              <?php 
                                        ...
                                        <!-- <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        <button type="button" class="ref-btn add-cont-btn" id="add_more_btn2">Add</button>
                                                    </div>
                                                  </div>
                                            </div>
                                        </div> -->
                                            ...
                                            <div class="col-md-12">
                                              ...
                                              <tbody id="tab_body_2">
                                                  <?php //if(!empty($employee_pf)){ ?>
                                                        ...
                                                        <?php  //$j = 0; foreach($employee_pf['pf_name'] as $pf){ ?>
                                                        
                                                         <tr width="100%" class="add_more_pf" id="add_more_pf'<?php //echo $j; ?>'" style="">
                                                         	<td> <?php //echo $j+1; ?></td>
                                                            <td><input type="text" name="pf_name[]" class="form-control form-control-sm" id="pf_name<?php //echo $j; ?>" value="<?php //echo $pf; ?>"></td>
                                                            <td><input type="text" name="pf_family_dob[]" class="form-control form-control-sm" id="pf_family_dob<?php //echo $j; ?>" value="<?php //echo $employee_pf['pf_family_dob'][$j]; ?>"></td>
                                                            <td>
                                                              <?php 
...
function populatecity_c(c_state_id){
  ...
  function addnewfamily(){
        ...
        resulthtml +='<td scope="row">1</td>';
        resulthtml +='<td><input type="text" name="name[]" id="name0" class="form-control form-control-sm" required></td>';
        resulthtml +='<td><input type="date" name="family_dob[]" id="family_dob0" class="form-control form-control-sm"></td>';
        resulthtml +='<td><input type="text" name="family_age[]" id="age0" class="form-control form-control-sm"></td>';
        resulthtml +='<td><input type="text" name="aadhaar_no[]" id="aadhaar_no0" maxlength="14" class="form-control form-control-sm"></td>';
        //resulthtml +='<td><input type="text" name="relation[]" id="relation0" class="form-control form-control-sm"></td>';
        resulthtml +='<td><select id="relation0" class="form-control form-control-sm" name="relation[]" class="lh-width class="form-control form-control-sm""></select></td>';
        //resulthtml +='<td><input type="text" name="with_fam[]" id="with_fam0" class="form-control form-control-sm"></td>';
        resulthtml +='<td><select class="form-control form-control-sm" id="with_fam0" name="with_fam[]" data-position="0" class="lh-width with_fam"><option value="Y">Y</option><option value="N">N</option></select></td>';
        resulthtml +='</tr>';
        $("#tab_body_1").html(resulthtml);

    }

    // function addnewfamilyPf(){
    //     var resulthtml='';
    //     resulthtml +='<tr width="100%" class="add_more_pf" style="">';
    //     resulthtml +='<td scope="row">1</td>';
    //     resulthtml +='<td><input type="text" name="pf_name[]" id="pf_name0" class="form-control form-control-sm"></td>';
    //     resulthtml +='<td><input type="date" name="pf_family_dob[]" id="pf_family_dob0" class="form-control form-control-sm"></td>';
       
    //     //resulthtml +='<td><input type="text" name="pf_relation[]" id="pf_relation0" class="form-control form-control-sm"></td>';
    //     resulthtml +='<td><select id="pf_relation0" class="form-control form-control-sm" name="pf_relation[]" class="lh-width class="form-control form-control-sm""></select></td>';
    //     resulthtml +='</tr>';
    //     $("#tab_body_2").html(resulthtml);
...
<?php } ?>
    $("#add_more_btn").click(function () 
    {
        ...
        resulthtml +='<td><input type="text" name="name[]" id="name'+cnt+'" class="form-control form-control-sm" required></td>';
        resulthtml +='<td><input type="date" name="family_dob[]" id="family_dob'+cnt+'" class="form-control form-control-sm"></td>';
        resulthtml +='<td><input type="text" name="family_age[]" id="age'+cnt+'" class="form-control form-control-sm"></td>';
        resulthtml +='<td><input type="text" name="aadhaar_no[]" id="aadhaar_no'+cnt+'" class="form-control form-control-sm" required></td>';
        //resulthtml +='<td><input type="text" name="relation[]" id="relation'+cnt+'" class="form-control form-control-sm"></td>';
        resulthtml +='<td><select id="relation'+cnt+'" class="form-control form-control-sm" name="relation[]" class="lh-width class="form-control form-control-sm""></select></td>';
        ...
        var position = cnt;
        populateRelation(position);

    });


      <?php //if(!empty($employee_pf)){ ?>
    //var cnt2 = <?php //echo $pf-1 ; ?>;
<?php //} else { ?>
	//var cnt2 = 0;
...
<?php //} ?>
    ...
    //     resulthtml +='<td><input type="text" name="pf_name[]" id="pf_name'+cnt2+'" class="form-control form-control-sm"></td>';
    ...
    function validDetail()
    {
        ...
        if(!isValidated)
        {
          alert("DOJ should be Less than or Equal DOA");
          return false;
        }
      ...
      function populateRelation(index = 0){
        //alert(state_id);
       var result='';
        //var csrfName = $('.PVS_ERP_csrf').attr('name');
