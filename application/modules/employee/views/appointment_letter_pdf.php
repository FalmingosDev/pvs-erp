    ...
    <section class="per-section">
        ...
        <div class="row">
                <div class="col-md-12 logo-secu">
                    <img src="<?php echo base_url() . 'assets/images/secu-logo.png'; ?>" class="img-fluid text-right">
                </div>
            </div>
            <div class="row">
            <div class="col-md-12">  
            ...
            <div class="row">
                <div class="col-md-12">
                <p style="text-align: center;font-weight: 600;"><b><u>Sub: Fixed Term Appointment</u></b></p>
