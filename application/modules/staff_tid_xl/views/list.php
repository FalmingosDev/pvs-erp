...
<section class="main-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php  echo form_open( base_url( 'staff_tid_xl/staff_tid_xl_excel' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) );  ?>
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="text-align: center;">Staff Payment Bank Transfer Details</h1>
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-3">
...
<script>
    ...
    function staff_search()
    {
		...
		$.ajax({
			type: 'POST',   
			url: '<?php echo base_url('staff_tid_xl/search_data'); ?>',
