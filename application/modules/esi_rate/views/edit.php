                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row pb-2">
                                        <div class="col-md-10">
                                            <h1 class="text-center">Edit Esi </h1> 
                                        </div>
                                        <div class="col-md-2">
                                            ...
                                            <div class="wrapper-box">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="date" name="effective_date" id="effective_date" class="form-control form-control-sm" value="<?php echo $edit_esi->effective_date; ?>" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                            <input type="text" class="form-control form-control-sm" name="percentage" id="percentage" placeholder="Employee Contribution" value="<?php echo $edit_esi->percentage; ?>" />
                                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                            <input type="text" class="form-control form-control-sm" name="comp_percentage" id="comp_percentage" placeholder="Employer Contribution" value="<?php echo $edit_esi->comp_percentage; ?>" />
                                                            </div>
