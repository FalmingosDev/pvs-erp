...
<section class="main-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php  echo form_open( base_url( 'staff_tid_report/tid_excel' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) );  ?>
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="text-align: center;">Staff TID Report</h1>
                    </div>
                </div>
                    <div class="row">
...
<script>
    ...
    function staff_search()
    {
       ...
       // alert(year);		
		...
		$.ajax({
			type: 'POST',   
			url: '<?php echo base_url('staff_tid_report/search'); ?>',
