<?php
class Paysupp_register_exc_model extends CI_Model {
...
WHERE ph.payment_month = '".$date."' ");
	...
	public function list_proc($month_id,$client_id,$emp_id,$branch_id){
		...
		/*echo "EXEC paysupp_hold_proc @p_month_id= '". $month_id ."',@p_client_id= '". $client_id ."',@p_emp_id= '". $emp_id ."',@p_branch_id= '". $branch_id ."'  "; die;*/
