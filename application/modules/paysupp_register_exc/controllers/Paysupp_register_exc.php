...
class Paysupp_register_exc extends MY_Controller {
  ...
  public function __construct() {
    ...
    $this->load->model('Paysupp_register_exc_model','pm');
  ...
  public function index(){
    ...
    if(check_uri_permission('paysupp_register_exc', 'V') == 0){
	...
	public function update()
	{
	 ...
	 public function Clielt_supp_hold_excel()
		...
		// $sheet->setCellValue('B', $row['order_no']);
		 ...
		 $filename = 'Payroll_Suplimente_Register_excel';
