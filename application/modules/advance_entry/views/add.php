                                ...
                                <div class="row">
                                    <div class="col-md-6">
										<div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <select id="employee_id" name="employee_id" class="form-control form-control-sm select2" onchange ="list()" required>
								...
								<div class="row">
                                    <div class="col-md-6">
										<div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type = "text" name="remarks" id="remarks" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
