                      ...
                      <div class="container">
                        <div class="row">
							...
							<?php echo form_open( '', array( 'id' => 'loginform', 'class' => 'form-horizontal' ) ); ?>
                                ...
                                <form>	
								<input type="hidden" name="id" value="<?php echo $view->qualification_id; ?>">								
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                          <input type="text" class="form-control form-control-sm" placeholder="Qualification Name" id="qualification_name" name="qualification_name" value="<?php echo $view->qualification_name; ?>">
                                                    </div>
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
														<input class="form-control form-control-sm" type="text" name="qualification_short_name" id="qualification_short_name" placeholder="Qualification Short Name" value="<?php echo $view->qualification_short_name; ?>">
