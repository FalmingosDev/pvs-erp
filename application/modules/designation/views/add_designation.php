                      ...
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row pb-2">
                                    <div class="col-md-11">
                                        <h1 class="text-center">Add Designation</h1>
                                    </div>
                                    <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <input type="text" class="form-control form-control-sm" name="designation_name" placeholder="Designation name" value="<?php echo set_value('designation_name'); ?>"/>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" name="desig_short_name" placeholder="Designation Short name" value="<?php echo set_value('desig_short_name'); ?>" />
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" name="rank" placeholder="Rank" value="<?php echo set_value('rank'); ?>"/>
                                                    </div>
