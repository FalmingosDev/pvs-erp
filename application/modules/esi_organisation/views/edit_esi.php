                      ...
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row pb-2">
                                    <div class="col-md-7">
                                        <h1>Edit ESI Organisation</h1>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="add-btn-div">
                                            <a href="<?php echo base_url('training_type'); ?>" class="ad-btn-a-tag">Back</a>  
                                        </div>
                                    </div>
                                </div>
							...
							<?php echo form_open( '', array( 'id' => 'loginform', 'class' => 'form-horizontal' ) ); ?>
                                ...
                                <form>	
								<input type="hidden" name="id" value="<?php echo $view->esi_organisation_id; ?>">								
								...
								<div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                          <input type="text" class="form-control form-control-sm" placeholder="ESI Organisation Name" id="organisation_name" name="organisation_name" value="<?php echo $view->organisation_name; ?>">
                                                    </div>
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                          <input type="text" class="form-control form-control-sm" placeholder="ESI Number" id="organisation_number" name="organisation_number" value="<?php echo $view->esi_no; ?>">
                                                    </div>
