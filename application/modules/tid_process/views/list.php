        ...
        <div class="container">
            <div class="row">
                ...
                <?php if($this->session->flashdata('error')): ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="text-align: center;">Lock Process For Client Payroll</h1>
                        </div>
                        
                    </div>
                    <?php echo form_open( base_url('tid_process/index'), array( 'id' => 'loginform', 'class' => 'form-horizontal')); ?>
                     ...
                     <div class="row">                        
                      ...
                      <?php echo form_open( base_url('tid_process/update'), array( 'id' => 'tidUpdate', 'class' => 'form-horizontal')); ?>
