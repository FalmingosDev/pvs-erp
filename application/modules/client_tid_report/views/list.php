                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php 
                                        $attributes = array('class' => 'form-control form-control-sm', 'id' => 'payment_month');
                                        $selected = (set_value('payment_month')) ? set_value('payment_month') : '';
                                        echo form_dropdown('payment_month', $payment_month, $selected, $attributes);
                                    ?>
                                </div>
                            </div>    
                        </div>
