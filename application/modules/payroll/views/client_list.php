        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row mb-3">  
                        <div class="col-md-7">
                            <h1 style="text-align: left;">Process Client Payment</h1>
                        </div>
                    ...
                    <?php endif; ?>
                    <?php echo form_open( base_url( 'payroll' ), array( 'id' => 'payroll_process', 'class' => 'form-horizontal' ) ); ?>
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    function populatebranch(){
        ...
        $.ajax({
            type: 'POST',   
            url: '<?php echo base_url('payroll/branch_list'); ?>',
    ...
    $("#submit_search").click(function(event){
    	...
    	//alert(1);
        if(month != '' && client_id != '' && branch_id != null){
            $('#client-table').show();
                $.ajax({
         type:'POST',
         url: '<?php echo base_url('payroll/search_list'); ?>',
         ...
         success: function(data) {
            ...
            $("#client-table").DataTable();
            //alert(branch_id);
            if (month != '' && client_id != '' && branch_id != null && c > 0)
            {
                $('#client-table').show();
                $("#payroll_div").show();
            }
