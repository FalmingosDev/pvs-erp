        ...
        <div class="container">
            <div class="row">
                ...
                <?php if($this->session->flashdata('error')): ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 style="text-align: center;">Lock Process For Staff Payroll</h1>
                        </div>
                        
                    </div>
                    <?php echo form_open( base_url('staff_pay/index'), array( 'id' => 'loginform', 'class' => 'form-horizontal')); ?>
                     ...
                     <div class="row">                        
                      ...
                      <?php echo form_open( base_url('staff_pay/update'), array( 'id' => 'tidUpdate', 'class' => 'form-horizontal')); ?>
                                  ...
                                  if(!empty($payroll_search))
                                  {
                                    ...
                                    ?>
                                          ...
                                          <td><?php echo $payrollsearch->branch_name; ?></td>
                                           <td><input type="checkbox"  name="payroll_checkbox[]"  value="<?php echo $count_tid_ck->serial_no.'#**#'.$payrollsearch->employee_id.'#**#'.$payrollsearch->branch_id.'#**#'.$payrollsearch->payment_month; ?>"></td>
                                      </tr>
                                  <?php 
                                    } 
                                  }
