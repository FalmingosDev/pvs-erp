...
class Staff_model extends CI_Model {
	...
	public function employee_list($user_branch_id = 1) {
		...
		LEFT JOIN designation_mst dm ON dm.desig_id = e.designation_id INNER JOIN company_branch_mst cm ON cm.company_branch_id = e.company_branch_id WHERE e.job_type='G' 
		" . $branch_condition . "
