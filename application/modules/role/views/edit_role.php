                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                        <input class="form-control form-control-sm" type="text" name="role_name" id="role_name" placeholder="Role Name" value="<?php echo $role->role_name; ?>" >
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                        <input class="form-control form-control-sm" type="text" name="role_st_name" id="role_st_name" placeholder="Role Short Name " value="<?php echo $role->role_short_name; ?>">
