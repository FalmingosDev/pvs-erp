...
<section class="main-wrapper">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <?php 
                                                        // $options = array('' => 'Select Contract Type','Event' => 'Event', 'Temporary' => 'Temporary','Regular' => 'Regular');
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input name="releiver_chrg" id="releiver_chrg" type="text" class="form-control form-control-sm" maxlength="20" value="<?php echo (set_value('releiver_chrg')) ? set_value('releiver_chrg') : ($edit_billing_costing->releiver_chrg == '') ? 0 : $edit_billing_costing->releiver_chrg; ?>">
                                                    </div>
                                                  </div>
                                                    <div class="form-group mb-0 row">
    ...
    function populateCalculation()
    {
        ...
        var final_monthly_ctc = monthly_ctc.toFixed(2);
        ...
        else
        {
            ...
            $("#total_ctc_amt").val(final_monthly_ctc);
        }
        ...
        if(service_chrg_amt > '0.00')
        {
            ...
            $("#gross_profit").val(final_service_chrg_amt);
        }
        else
        {
            total_bill_amt = '0.00';
        ...
        //alert(final_total_bill_amt);
        // var final_total_bill_amt = total_bill_amt.toFixed(2);
        //console.log(total_bill_amt, total_bill_amt.toFixed(2));

         if(isNaN(total_bill_amt.toFixed(2)))
        {
          $("#total_bill_amt").val('0.00');
        }
        else
        {
            $("#total_bill_amt").val(total_bill_amt.toFixed(2));
        }
        //$("#total_bill_amt").val(final_total_bill_amt);
        ...
        pay_hrs = ((net_pay/duty_hrs)/bill_calculation_days);
        //alert(pay_hrs);
        //pay_hrs = ((net_pay/duty_hrs)/bill_calculation_days);
        var pay_hrs_amt = pay_hrs.toFixed(2);
        //console.log(pay_hrs_amt);
