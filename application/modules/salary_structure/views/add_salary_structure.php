                            ...
                            <?php endif; ?>   
                                ...
                                <?php echo validation_errors(); ?> 
                                    <div class="wrapper-box">
                                        <?php echo form_open( base_url( 'salary_structure/add/'.$employee->employee_id ), array( 'id' => 'salarystructureform', 'class' => 'form-horizontal form-hori-border','onSubmit' => 'return validDetail()' ) ); ?>
                                        ...
                                        <div class="row">  
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p><?php echo $employee->desig_name; ?></p>
                                                    </div>
                                                  </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php 
                                                            ...
                                                            $selected = (set_value('dept_id')) ? set_value('dept_id') : '';
                                        ...
                                        <div class="row">  
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control form-control-sm" id="" name="eff_date" value="<?php echo set_value('eff_date'); ?>">
                                                    </div>
                                                  </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <label class="cont-radio-location"><input type="checkbox" name="applicable_for[]" id="applicable_for_I" value="I">Increment</label>
														<label class="cont-radio-location"><input type="checkbox" name="applicable_for[]" id="applicable_for_P" value="P" onclick="showHideDesignation()">Promotion</label>
                                                    </div>
													<div class="col-sm-4" id="designation_div" style="display:none;">
                                         ...
                                         <div class="row">  
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="gross_pay" name="gross_pay" value="<?php echo set_value('gross_pay'); ?>">
                                                    </div>
                                                  </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="email" class="form-control form-control-sm" id="" name="email" value="<?php echo set_value('email'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                        <div class="row">  
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control form-control-sm" id="" name="pf_wage" value="<?php echo set_value('pf_wage'); ?>">
                                                    </div>
                                                  </div>
                                                <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">OT Rate : </label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control form-control-sm" id="" name="ot_rate" value="<?php echo set_value('ot_rate'); ?>">
                                                    </div>
                                                  </div>
                                                  <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Monthly CTC : </label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control form-control-sm" id="monthly_ctc" name="monthly_ctc" readonly="" value="<?php echo set_value('monthly_ctc'); ?>">
                                                    </div>
                                                  </div>
                                                  <div class="form-group row">
                                                    <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">Annual CTC : </label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control form-control-sm" id="annual_ctc" name="annual_ctc" readonly="" value="<?php echo set_value('annual_ctc'); ?>">
                                                    </div>
                                                  </div>
                                              </div>
                                            </div>
                                        <div class="row">
                                                <div class="col-md-6" style="border: 1px solid #c3baba;margin: 18px 0px;">  
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="ob_el" readonly="" value="<?php echo (set_value('ob_el')) ? set_value('ob_el') : $employee->opening_el; ?>">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="colFormLabelSm" class="col-sm-3 pr-0 col-form-label col-form-label-sm">SL :</label>
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="ob_sl" readonly="" value="<?php echo (set_value('ob_sl')) ? set_value('ob_sl') : $employee->opening_sl; ?>">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="colFormLabelSm" class="col-sm-3 pr-0 col-form-label col-form-label-sm">CL :</label>
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="ob_cl" readonly="" value="<?php echo (set_value('ob_cl')) ? set_value('ob_cl') : $employee->opening_cl; ?>">
                                                    </div>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col-md-6" style="border: 1px solid #c3baba;margin: 18px 0px;">  
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="colFormLabelSm" class="col-sm-3 pr-0 col-form-label col-form-label-sm">EL :</label>
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="lt_el" readonly="" value="<?php echo (set_value('lt_el')) ? set_value('lt_el') : $employee->el; ?>">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="colFormLabelSm" class="col-sm-3 pr-0 col-form-label col-form-label-sm">SL :</label>
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="lt_sl" readonly="" value="<?php echo (set_value('lt_sl')) ? set_value('lt_sl') : $employee->sl; ?>">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="colFormLabelSm" class="col-sm-3 pr-0 col-form-label col-form-label-sm">CL :</label>
                                                        <div class="col-sm-9">
                                                        <input type="text" class="form-control form-control-sm" id="" name="lt_cl" readonly="" value="<?php echo (set_value('lt_cl')) ? set_value('lt_cl') : $employee->cl; ?>">
                                                    </div>
                                                    </div>
                                                </div>
                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="salary-table" class="table table-striped table-bordered" style="width:100%">
                                                        ...
                                                        <tbody id="salary_body">
                                                            ...
                                                            <?php foreach($salary_data as $sal){ ?>
                                                                 <tr>
                                                                    <td><?php echo date("d/m/Y", strtotime($sal->effective_date)); ?></td>
                                                                    <td><?php echo $sal->desig_name; ?></td>
                                                                    <td style="text-align: right;"><?php echo $sal->gross_pay; ?></td>
                                                                    <td><?php echo $sal->monthly_ctc; ?></td>
                                                                    <td><?php echo $sal->annual_ctc; ?></td>
                                                                    <td style="text-align: center;"><a href="<?php echo base_url('salary_structure/edit/'.$sal->salary_structure_id.'/'.$sal->employee_id); ?>"><i class="fa fa-pencil-square-o pencil-font" aria-hidden="true"></i></a></td>
                                                                </tr>
...
<script>
  ...
  function populatesalaryhead(){
        ...
        resulthtml +='<td><input id="rate0" name="rate[]" data-position="0" type="text" class="lh-width rate" value="" placeholder="0"><input id="max_prcnt0" name="max_prcnt[]" data-position="0" type="hidden" class="lh-width max_prcnt" value=""><input id="min_prcnt0" name="min_prcnt[]" data-position="0" type="hidden" class="lh-width min_prcnt" value=""></td>';
