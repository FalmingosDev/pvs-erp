...
<section class="main-wrapper">  
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="wrapper-box">
                                    ...
                                    <input type="hidden" name="billing_costing_skilled_id" value="<?php echo @$edit_billing_costing_skilled_detail->billing_costing_skilled_id; ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-check pr-4">
                                                            <input class="form-check-input" type="radio" name="billing_type" id="monthly" value="m" <?php if($edit_billing_costing->billing_type=='m') echo "checked='checked'"; ?> <?php echo set_checkbox('billing_type', 'm'); ?>>
                                                            <label class="form-check-label" for="exampleRadios1">
                                                                    MONTHLY
                                                            </label>
                                                        </div>
                                                        <div class="form-check pr-4">
                                                            <input class="form-check-input" type="radio" name="billing_type" id="days" value="d" <?php if($edit_billing_costing->billing_type=='d') echo "checked='checked'"; ?> <?php echo set_checkbox('billing_type', 'd'); ?>>
                                                            <label class="form-check-label" for="exampleRadios2">
                                                                    DAYS
                                                            </label> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4" id="cal_div" style="display: none;">
                                                        <input name="bill_calculation_days" id="bill_calculation_days" type="text" class="form-control form-control-sm" style="margin-top: 19px;" value="<?php echo (set_value('bill_calculation_days')) ? set_value('bill_calculation_days') : $edit_billing_costing->bill_calculation_days; ?>"> 
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="col-md-5" id="days_div" style="display: none;">
                                                            <input name="salary_days" id="salary_days" type="text" class="form-control form-control-sm" style="margin-top: 19px;" value="<?php echo (set_value('salary_days')) ? set_value('salary_days') : $edit_billing_costing->salary_days; ?>"> 
                                                        </div>
                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row border-box mr-0 p-0">
                                                  ...
                                                  <div class="form-group row">
                                        <div class="col-md-12 table-ad pl-0 mt-3">
                                           <table class="table-bordered" style="width: 100%;margin-bottom: 17px;">  
                                                    <tr>
                                                        <td colspan="4" style="border: none;text-align: right;">Rate Of Minimum Wages Since The Date : </td>
                                                        <td colspan="2" style="border: none;text-align: left;"><input style="width: 100%;border: 2px solid #dee2e6;" type="date" name="effective_date" value="<?php echo (set_value('effective_date')) ? set_value('effective_date') : @$edit_billing_costing_skilled_detail->effective_date; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <th style="">&nbsp;</th>
                                                    ...
                                                    <tr>
                                                        <td>Basic</td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="basic_highly_skilled" value="<?php echo (set_value('basic_highly_skilled')) ? set_value('basic_highly_skilled') : @$edit_billing_costing_skilled_detail->basic_highly_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="basic_skilled" value="<?php echo (set_value('basic_skilled')) ? set_value('basic_skilled') : @$edit_billing_costing_skilled_detail->basic_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="basic_semi_skilled" value="<?php echo (set_value('basic_semi_skilled')) ? set_value('basic_semi_skilled') : @$edit_billing_costing_skilled_detail->basic_semi_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="basic_un_skilled" value="<?php echo (set_value('basic_un_skilled')) ? set_value('basic_un_skilled') : @$edit_billing_costing_skilled_detail->basic_un_skilled; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>DA</td> 
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="da_highly_skilled" value="<?php echo (set_value('da_highly_skilled')) ? set_value('da_highly_skilled') : @$edit_billing_costing_skilled_detail->da_highly_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="da_skilled" value="<?php echo (set_value('da_skilled')) ? set_value('da_skilled') : @$edit_billing_costing_skilled_detail->da_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="da_semi_skilled" value="<?php echo (set_value('da_semi_skilled')) ? set_value('da_semi_skilled') : @$edit_billing_costing_skilled_detail->da_semi_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="da_un_skilled" value="<?php echo (set_value('da_un_skilled')) ? set_value('da_un_skilled') : @$edit_billing_costing_skilled_detail->da_un_skilled; ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>OT</td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="overtime_highly_skilled" value="<?php echo (set_value('overtime_highly_skilled')) ? set_value('overtime_highly_skilled') : @$edit_billing_costing_skilled_detail->overtime_highly_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="overtime_skilled" value="<?php echo (set_value('overtime_skilled')) ? set_value('overtime_skilled') : @$edit_billing_costing_skilled_detail->overtime_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="overtime_semi_skilled" value="<?php echo (set_value('overtime_semi_skilled')) ? set_value('overtime_semi_skilled') : @$edit_billing_costing_skilled_detail->overtime_semi_skilled; ?>"></td>
                                                        <td><input class="form-control form-control-sm text-right" style="width: 100%;" type="text" placeholder="0" name="overtime_un_skilled" value="<?php echo (set_value('overtime_un_skilled')) ? set_value('overtime_un_skilled') : @$edit_billing_costing_skilled_detail->overtime_un_skilled; ?>"></td>
                                                    </tr>
                                            </table> 
                                        </div>
                                    </div>
    ...
    <?php if($edit_billing_costing->billing_type == 'd'){ ?>
        $("#cal_div").show();
    <?php } else { ?>
        $("#cal_div").hide();
    <?php } ?>
    ...
    $('input[type=radio][name=billing_type]').change(function() {
        //alert(this.value);
        if (this.value == 'd') {
            $("#bill_calculation_days").val('');
            $("#cal_div").show();
        }
        else if (this.value == 'm') {
            $("#bill_calculation_days").val(30);
            $("#cal_div").hide();
        }
    });
