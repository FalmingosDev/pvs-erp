...
class Attendance_model extends CI_Model
{
  ...
  {
    $query = $this->db->query("select attendance_month from staff_attendance;");
    return $query->result();
  }
