                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control form-control-sm" id="state_id" name="state_id" placeholder="Select Staet" required="required">
                                                            <option value= <?PHP echo $lwfeditdetail->state_id; ?>><?PHP echo $lwfeditdetail->state_name; ?></option>
                                            ...
                                            <table class="table table-striped table-bordered" style="width:100%">
												...
												<input type="hidden" name="lwf_id" id="lwf_id"  value = <?PHP echo $lwfeditdetail->lwf_id; ?> >
                                                    <tr class="add_more_contact" id="add_more_contact" style="width:100%;">
														<td><input type="date" required="" name="period_from" class="form-control form-control-sm date-picker" id="period_from" value = <?PHP echo $lwfeditdetail->period_from; ?>></td>
														<td><input type="date" name="period_to" class="form-control form-control-sm date-picker" id="period_to"  value = <?PHP echo $lwfeditdetail->period_to; ?> ></td>
														<td><input type="number" required=""  name="employee_contribution" class="form-control form-control-sm" id="employee_contribution" onkeyup="final_count()" onblur="final_count()" value = <?PHP echo $lwfeditdetail->employee_contribution; ?>></td>		 
														<td><input type="number" required="" name="employer_contribution" class="form-control form-control-sm" id="employer_contribution" onkeyup="final_count()" onblur="final_count()" value = <?PHP echo $lwfeditdetail->employer_contribution; ?> ></td>
														<td><input type="number" required="" name="total" class="form-control form-control-sm" id="total" value = <?PHP echo $lwfeditdetail->total; ?> readonly></td>      
