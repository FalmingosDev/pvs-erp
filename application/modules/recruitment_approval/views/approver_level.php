                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-client" role="tabpanel" aria-labelledby="nav-home-tab">
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="employee-box">Recruitment Approval Definition</h1>
									...
									<?php echo form_open(base_url('recruitment_approval/add' ), array('id' => 'approver', 'name' => 'approver'));?>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
													...
													Active
													<label class="switch" title="Mark as Inactive"> <input type="checkbox" checked="checked" onclick="if(confirm('Are you sure want to change the status?')){ window.location.assign('<?php echo base_url('recruitment_approval/change_status/'.$list->recruitment_approver_id.'/'.$list->active_status); ?>'); } else{ return false; }"> <span class="switch-slider round"></span> </label>
												</td>
																...
																<td style="text-align: center;">
													Inactive
													<label class="switch" title="Mark as Active"> <input type="checkbox" onclick="if(confirm('Are you sure want to change the status?')){ window.location.assign('<?php  echo base_url('recruitment_approval/change_status/'.$list->recruitment_approver_id.'/'.$list->active_status); ?>'); } else{ return false; }"> <span class="switch-slider round"></span> </label>
												</td> 
...
function addapprover1(){
		...
		row_html +='<div class="" id="" ></div>';
				...
				row_html +='<div class="form-group row">';
				  ...
				  row_html +='<button type="button" class="cr-a" id="add_app1" onclick="add_emp()">Add</button>';
				row_html +='</div>';
				row_html +='</div>';
