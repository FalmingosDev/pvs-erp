...
class Delete_client_salary extends MY_Controller 
{
	...
	public function __construct() 
	{
		...
		$this->load->model('Delete_client_salary_model');
	...
	public function index()
	{
		...
		{
			$data['list'] = $this->Delete_client_salary_model->get_all_records($data['month_year'],$data['client_id'],$data['branch_id']);
		}
		else{
			$data['list'] = array();
		}

		$month_obj = $this->Delete_client_salary_model->get_all_month();
		...
		$this->template->write('title', 'Delete Client Salary', TRUE);
	...
	public function branch_list(){
		...
		$data['branch_list'] = $this->Delete_client_salary_model->get_all_branch($month_year);
	...
	public function client_list(){
		$month_year = $this->input->post('month_year');
		$data['client_list'] = $this->Delete_client_salary_model->get_all_client($month_year);
	...
	public function delete(){
		...
		//print_r($id); exit;
		$this->Delete_client_salary_model->delete($payment_month,$client_id,$branch_id);
	...
	public function search()
	{
		...
		$data['list'] = $this->Delete_client_salary_model->get_all_records($month_year,$client_id,$branch_id);
