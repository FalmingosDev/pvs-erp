                      ...
                      <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row pb-2">
                                    <div class="col-md-11">
                                        <h1 class="text-center">Edit Bank</h1>
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <?php //echo validation_errors(); ?>
                                 <?php foreach($bank as $ed_dept){ ?>
                                <!-- <h1>Client Master</h1> -->

                                <?php echo form_open( base_url( 'bank/UpdateBank' ), array( 'id' => 'bankform', 'class' => 'form-horizontal' ) );  ?> 
                                <input type="hidden" name="bank_id" value="<?php echo $ed_dept['bank_id']; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <input type="text" class="form-control form-control-sm" name="bank_name" placeholder="Bank Short name" value="<?php echo $ed_dept['bank_name']; ?>" />
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="hidden" class="form-control form-control-sm" name="branch_name" placeholder="Branch name" value="<?php echo $ed_dept['branch_name']; ?>" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                      <input type="text" class="form-control form-control-sm" name="address" placeholder="Bank Name" value="<?php echo $ed_dept['address']; ?>" />
