                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-client" role="tabpanel" aria-labelledby="nav-home-tab">
                      <div class="container">
                        <div class="row">
                        <div class="col-md-11">
                                <h1 class="employee-box">Client Supp Attendance Entry</h1>   
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-12">
                                ...
                                <?php endif; ?>
							<?php echo form_open( base_url( 'client_supp_attendance/add_client_attendance' ), array( 'id' => 'clientattendance', 'class' => 'form-horizontal' ) ); ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control form-control-sm select2" id="branch_id" name="branch_id" onchange="populateemployee()">
...
$("#proceed").click(() => {
	...
	$.ajax({
        type: 'GET',   
        url: '<?php echo base_url('client_supp_attendance/client_emp_details'); ?>/' + client_id + '/' + emp_id + '/' + branch_id + '/' + designation_id,
        dataType: 'json',
    })
    //ajax response
    .done(function(data){
