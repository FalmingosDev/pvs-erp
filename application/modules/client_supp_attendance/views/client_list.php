        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row mb-3">  
                        <div class="col-md-7">
                            <h1 style="text-align: left;">Client Supp Attendance</h1>
                        </div>
                        <div class="col-md-5">
                            <div class="add-btn-div">
                                <a href="<?php echo base_url('client_supp_attendance/add_client_attendance'); ?>" class="ad-btn-a-tag">Attendance Input</a>  
                            </div>
                        </div>
                    </div>
                    <?php echo form_open( base_url( 'client_supp_attendance/client' ), array( 'id' => 'search', 'class' => 'form-horizontal' ) ); ?>
                    <div class="row">
                        <div class="col-md-5">
								    ...
								    <?php foreach($client_attendance as $att) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($att->salary_processed_flag == '0') { ?>
                                                <td style="text-align: center;"><i class="icon-edit"></i><a class="edit-tag-icon" href="<?php echo base_url('client_supp_attendance/edit_client_attendance/'.$att->client_supp_attendance_id); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                            <?php } else { ?>
													...
													if($att->approval_required == 0){ echo "N/A"; }
														...
														if($att->approval_status == 'A'){ echo "Approved"; }
															...
															if($approval->has_permission == 0){
																...
																echo '<a class="vd-ed-2" href="' . base_url("client_supp_attendance/approve/" . $att->client_supp_attendance_id) . '"> Approve</a>';
															}
														}
