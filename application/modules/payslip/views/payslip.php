...
<body>
    <div style="width: 100%">
        <div style="width: 87%;margin: 0 auto;background: #fff;padding: 20px 28px;border: 1px solid #000;">
            <table>
        <tr>
            <td style="width: 5%;"><img src=<?php echo base_url("assets/images/pvs-2.png");  ?> style="width: 70px;"></td>
            ...
            <td style="width: 5%;"><img src=<?php echo base_url("assets/images/pvs-1.png");   ?> style="float: right;width: 70px;"></td>
       </tr>
    </table>
            <table>
                <!--<tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 40%;font-size: 15px;">LOCATION :&nbsp;&nbsp;<?PHP echo $payslip_lst->branch_name; ?></td>  
                </tr>
                <tr>
                    ...
                    <td style="border: 1px solid #000;border-bottom: none;border-top: none;">
                        <table style="width: 100%;">
                            <tr id="duties-row">
                                ...
                                <td id="duties" style="text-align: right;padding-right: 10px;"> <?PHP echo $payslip_lst->duties; ?></td>
                            </tr>
							<?PHP if ($payslip_lst->otduty != '.00') {	?>
                            <tr id="otduty-row">
                     ...
                     <td>
                        <table style="width: 100%;border: 1px solid #000;border-bottom: none;border-top: none;">
							...
							<?PHP }	?>
							<?PHP if ($payslip_lst->esi_amt != '.00') {	?>
                            <tr id="esi-row">
                                <td id="esi-col" style="padding-left: 10px;">ESI</td> 
                                <td id="esi" style="text-align: right;padding-right: 10px;"><?PHP echo $payslip_lst->esi_amt; ?></td>
                            </tr>
							<?PHP }	?>
							<?PHP if ($payslip_lst->ptax != '.00') {	?>
                            <tr id="ptax-row">
							...
							<?PHP }	?>
							<?PHP if ($payslip_lst->fine_deduct != '.00') {	?>
                            <tr id="fine_deduct-row">
                                <td id="fine_deduct-col" style="padding-left: 10px;">Fine</td> 
                                <td id="fine_deduct" style="text-align: right;padding-right: 10px;"><?PHP echo $payslip_lst->fine_deduct; ?></td>
                            </tr>
							<?PHP }	?>
							<?PHP if ($payslip_lst->uniform_deduct != '.00') {	?>
                            <tr id="uniform_deduct-row">
                                <td id="uniform_deduct-col" style="padding-left: 10px;">Uniform</td> 
                                <td id="uniform_deduct" style="text-align: right;padding-right: 10px;"><?PHP echo $payslip_lst->uniform_deduct; ?></td>
                            </tr>
							<?PHP }	?>
							<?PHP if ($payslip_lst->lwf != '.00') {	?>
                            <tr id="lwf-row">
							...
							<?PHP }	?>
							<?PHP if ($payslip_lst->adv != '.00') {	?>
                            <tr id="adv-row">
                                <td id="adv-col" style="padding-left: 10px;">Adv / Loan</td> 
