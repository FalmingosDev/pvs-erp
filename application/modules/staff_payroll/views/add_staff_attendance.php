                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control form-control-sm" name="branch" id="branch" onchange="employee_fetch()" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control form-control-sm" name="employee" id="employee" onchange="desig_fetch(); getLeaves();" required>
