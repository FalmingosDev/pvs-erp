...
<section class="main-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php  echo form_open( base_url( 'client_tid/client_tid_pdf' ), array( 'id' => 'loginform', 'class' => 'form-horizontal' ) );  ?>
                <div class="row">
                    <div class="col-md-7">
                        <h1 style="text-align: center;">Client Payment Bank Transfer Statement</h1>
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <?php 
                                        ...
                                        echo form_dropdown('year', $year, $selected, $attributes);
                                    ?>
                                </div>
                            </div>    
                        </div>
...
<script>
    ...
    function staff_search()
    {
		...
		$.ajax({
			type: 'POST',   
			url: '<?php echo base_url('client_tid/search'); ?>',
		...
		.done(function(data){
            ...
            var pdf_result = '';
                ...
                var loc = "client_tid/client_tid_pdf?year="+year+ "& month=" +month+ "& tid=" +tid;
                // alert(loc);
                if($("#tid").val() != ''){
                    pdf_result += '<div class="add-btn-div">'; 
                    pdf_result += '<a href="<?php echo base_url('client_tid/client_tid_pdf'); ?>?year='+year+'&month='+month+'&tid='+tid+'" class="cr-a" >PDF Download</a> ';
                    pdf_result += '</div>';
